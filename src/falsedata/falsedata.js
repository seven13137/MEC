...
export var falsePersonalTestbrief = [
    {
        'test_name':'关爱父母肿瘤12项升级套餐（女）',
        'id': 't10001',
        'path':'/t10001',
        'price':'982.00',
        'main_img':'/static/images/banner1.png',
        'applicable_object':'中老年女性 有型生活',
        'keyword':'心脑血管、肿瘤筛查、慢病筛查'
    },
    {
        'test_name':'关爱父母特惠体检套餐（女）',
        'id': 't10002',
        'path':'/t10002',
        'price':'474.00',
        'main_img':'/static/images/banner2.png',
        'applicable_object':'中老年女性 有型生活',
        'keyword':'心脑血管、肿瘤筛查、慢病筛查'
    },
    {
        'test_name':'成人高端体检套餐（男）',
        'id': 't10003',
        'path':'/t10003',
        'price':'1165.00',
        'main_img':'/static/images/banner3.png',
        'applicable_object':'中青年男性',
        'keyword':'心脑血管、肿瘤筛查、慢病筛查'
    },
    {
        'test_name':'职场白领关爱升级套餐（女）',
        'id': 't10004',
        'path':'/t10004',
        'price':'682.00',
        'main_img':'/static/images/banner4.png',
        'applicable_object':'中青年女性，有型生活',
        'keyword':'肿瘤筛查、白领人群、肾功能检查'
    }
];
export var falsePersonalTestInfo = {
    't10001':{
    'test_name':'关爱父母肿瘤12项升级套餐（女）',
    'id': 't10001',
    'path':'/t10001',
    'price':'982.00',
    'detail_pic':'/static/images/banner1.png',
    'applicable_object':'中老年女性 有型生活',
    'keyword':'心脑血管、肿瘤筛查、慢病筛查',
    'pro_count':'2',//套餐包含项目
    'bespack_time':'',//预约时间
    'hospital':[//所属医院
        {
            'hospital_name':"爱康国宾上海外滩延安乐路分院VIP部",
            'street_name':"上海市黄浦区江西南路29号2层",
            'distance':"1km",
            'status':true,//是否可预约
            'percent':"9%"//已预约数
        },
        {
            'hospital_name':"爱康国宾上海外滩延安乐路分院",
            'street_name':"上海市黄浦区江西南路29号2层",
            'distance':"1km",
            'status':false,//是否可预约
            'percent':""//已预约数
...
export var falseDentistrybrief = {

}
export var falseDentistryInfo = {
